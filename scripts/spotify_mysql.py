...
sp = spotipy.Spotify(auth_manager=SpotifyClientCredentials(
    client_id='b881f8e3edf24ac5aa17df3352df79ad',  # Replace with your Client ID
    client_secret='3a38115ea36b4278a522ed0f5106d130'  # Replace with your Client Secret
))

# MySQL Database Connection
db_config = {
    'host': 'localhost',           # Change to your MySQL host
    'user': 'spotifyproject',       # Replace with your MySQL username
    'password': 'spotifyproject',   # Replace with your MySQL password
